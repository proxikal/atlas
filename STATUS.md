...
**Last Updated:** 2026-02-22 (Block 2 Phases 01, 02, 03, 04, 05 complete)
...
**Status:** Block 2 in progress — Phases 01, 02, 03, 04, 05 complete
**Last Completed:** Phase 04 — Parser return type ownership annotations (7,281 tests passing)
**Next:** Phase 06 — Type-checker ingests ownership annotations (`phases/v0.3/block-02-ownership-syntax/phase-06-typechecker-ownership-ingestion.md`)
...
| 2 | Ownership Syntax (`own`, `borrow`, `shared`) | 16 | 🔄 In progress — Phases 01 ✅ 02 ✅ 03 ✅ 04 ✅ 05 ✅ |
